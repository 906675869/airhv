...
// key down or up
NTSTATUS KeyboardInput(PVOID DT) {
    PKEYBOARD_INPUT_DATA Data = (PKEYBOARD_INPUT_DATA)DT;
...
NTSTATUS MouseInput(PVOID Data) {
    PMOUSE_INPUT_DATA MouseInputDataStart = (PMOUSE_INPUT_DATA)Data;
    // DbgPrint("MouseInput ButtonFlags=%d Flags=%d", MouseInputDataStart->ButtonFlags, MouseInputDataStart->Flags);
